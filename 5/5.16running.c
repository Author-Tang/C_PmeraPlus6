/*
 * @Author: Author
 * @Date: 2021-07-02 16:18:10
 * @LastEditors: Author
 * @LastEditTime: 2021-07-02 16:58:10
 * @FilePath: \C_PrimerPlus\5\5.16running.c
 * @description: A useful program for runners一个对跑步者有用的程序
 */
#include <stdio.h>
...
int main()
{
    ...
    printf("Please enter,int kilometers,the distance run.\n");
